		...
		return (
			<View className="gap-card">
				...
				<Typography.Paragraph color="muted" className="text-xs leading-relaxed">
					The form also has an optional Social Security number box. This app leaves it blank and
					does not ask for your SSN. If you want the Social Security Administration to issue you a
					card, fill that short section in yourself on the printed form.
