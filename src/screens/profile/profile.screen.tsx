...
import { ProfileIdentity } from './profile.account'
...
/**
 * The full Profile page (M6-T5), reached from every tab's header avatar:
 * identity + account/conversion, editable filing details, the reusable
 * document library, community blocks, and account deletion.
 */
